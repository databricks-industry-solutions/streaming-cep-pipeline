...
RULE_PATH_1 = "/Volumes/cep_demo/network/rules/1-1.json"
RULE_PATH_2 = "/Volumes/cep_demo/network/rules/1-2.json"
...
stream_query = (
    ...
    .option("checkpointLocation", "/Volumes/cep_demo/network/checkpoints/s1_results_driver")
    .start()
)
